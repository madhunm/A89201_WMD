...
- **SCU `sel_spi0` must be configured** before SCI0 SPI is used. If this register is at reset value (0x0000_0000), SPI0 MISO input is not connected to any GPIO pin, and all SPI reads will return 0xFF.
