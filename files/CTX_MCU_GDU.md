...
The MCU accesses GDU configuration and diagnostics through a dedicated serial communication peripheral mapped in the APB bus (not SCI0/SCI1, and unrelated to the A1333 ABI/PWM interface).
